...
DEFAULT_INPUT_PATH = Path("nero_app/data/white_house_market_events.csv")
DEFAULT_OUTPUT_PATH = Path("reports/white_house_market_events_enriched.csv")
DEFAULT_SUMMARY_PATH = Path("reports/white_house_impact_summary.csv")
HORIZONS = (1, 7, 30)
